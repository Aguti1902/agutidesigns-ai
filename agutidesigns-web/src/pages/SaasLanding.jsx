  ...
  return (
    <div className="landing">
      ...
      <nav className="landing-nav">
        ...
        <a href="https://app.agutidesigns.io" className="landing-nav__cta">
        ...
        <div className="landing-container">
          ...
          >
            ...
            <div className="landing-hero__ctas">
              <a href="https://app.agutidesigns.io" className="landing-btn landing-btn--primary landing-btn--lg">
      ...
      <section className="landing-pricing">
        <div className="landing-container">
          ...
          <div className="landing-pricing__card">
            ...
            <a to="/" className="landing-btn landing-btn--primary landing-btn--xl landing-btn--full">
      ...
      <section className="landing-final">
        <div className="landing-container">
          ...
          <p>Únete a cientos de negocios que ya usan IA para crecer más rápido.</p>
            <a href="https://app.agutidesigns.io" className="landing-btn landing-btn--primary landing-btn--xl">
